-- Sample Data for Fashion E-Commerce Application
...
-- Insert Size Guides
INSERT INTO size_guides (category_id, size, chest_cm, waist_cm, hip_cm, length_cm) VALUES
(1, 'XS', 82, 66, 89, 68),
(1, 'S', 87, 71, 94, 70),
(1, 'M', 92, 76, 99, 72),
(1, 'L', 97, 81, 104, 74),
...
-- Insert Coupons
INSERT INTO coupons (code, description, discount_type, discount_value, max_usage, min_purchase_amount, valid_from, valid_to, is_active) VALUES
('WELCOME20', 'Welcome discount 20% off', 'PERCENTAGE', 20, 1000, 50, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), TRUE),
('SAVE50', 'Save $50 on orders above $200', 'FIXED_AMOUNT', 50, 500, 200, NOW(), DATE_ADD(NOW(), INTERVAL 60 DAY), TRUE),
('SUMMER15', 'Summer collection 15% off', 'PERCENTAGE', 15, 2000, 100, NOW(), DATE_ADD(NOW(), INTERVAL 90 DAY), TRUE);
